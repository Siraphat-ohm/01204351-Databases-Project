...
>
  {/* Top Section: Passenger & Route */}
  <Stack gap="xs">
    <div>
      <Text size="xs" c="dimmed" tt="uppercase" fw={700}>Passenger</Text>
      <Text size="sm" fw={800} style={{ textTransform: 'uppercase' }}>
        {ticket.firstName} {ticket.lastName}
      </Text>
    </div>
    ...
    <Group justify="space-between" mt="xs">
      <div>
        <Text size="xs" c="dimmed" tt="uppercase" fw={700}>From</Text>
        <Text size="md" fw={900}>{ticket.flight?.route?.origin?.iataCode}</Text>
      </div>
      <IconPlaneDeparture size={14} color="#adb5bd" style={{ marginTop: '10px' }} />
      <div style={{ textAlign: 'right' }}>
        <Text size="xs" c="dimmed" tt="uppercase" fw={700}>To</Text>
        <Text size="md" fw={900}>{ticket.flight?.route?.destination?.iataCode}</Text>
      </div>
    </Group>
  </Stack>

  {/* Middle Section: Seat & Class */}
  <Group mt="md" justify="space-between" align="flex-end">
    <Stack gap={0}>
      <Text size="xs" c="dimmed" tt="uppercase" fw={700}>Seat</Text>
      <Text size="38px" fw={900} lh={1} c="blue.9">{ticket.seatNumber}</Text>
    </Stack>
  ...
  {/* Bottom Section: Barcode & Ref */}
  <Stack gap={10} mt="md">
    <div>
      <Text size="xs" c="dimmed" tt="uppercase" fw={700}>Reference</Text>
      <Text size="xs" fw={800}>{ref}</Text>
    </div>
    
    {/* Horizontal High-Density CSS Barcode */}
    <Box style={{ 
      width: '100%', 
      height: '45px', 
    ...
    <Text ta="center" size="8px" fw={600} style={{ letterSpacing: '3px', marginTop: '-6px' }}>
