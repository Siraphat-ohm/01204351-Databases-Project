...
import { Container, Title, Card, Text, Group, Badge, Stack, Loader, Center, Paper, Divider, Flex } from "@mantine/core";
      ...
      <Stack gap="xl">
        ...
        {groupedBookings.length === 0 ? (
          ...
          groupedBookings.map((group: any) => (
            <Card key={group.ref} withBorder shadow="sm" radius="md" p={0} onClick={() => router.push(`/history/${group.ref}`)}>
              <Flex align="stretch" direction={{ base: 'column', sm: 'row' }}>
                
                {/* --- LEFT SECTION: CENTERED FLIGHT INFO --- */}
                <Stack p="xl" style={{ flex: 1 }} justify="center">
